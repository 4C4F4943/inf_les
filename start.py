...
class PlasmaScene(Scene):
    ...
    _comments = [
        "tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python","tekenen met turtle in                             python"
    ]
    ...
    def _add_cheesy_comment(self,i):
        msg = FigletText(self._comments[i], "banner3")
    ...
    def reset(self, old_scene=None, screen=None):
        ...
        # comment.
            ...
            self._add_cheesy_comment(i)


def demo(screen):
    screen.play([PlasmaScene(screen)], stop_on_resize=False)
